  ...
  const feed = prettydata.pd.xmlmin(`<?xml version='1.0' encoding='UTF-8'?>
    ...
    <channel>
      ...
      <item>
        ...
        <![CDATA[
          <p>
            Поговорили о тканях с Наташей Балахонцевой. У неё есть «Мечта» — магазин тканей. Наташа пришла к нам и рассказала — с чего начинается мечта, зачем искать ткань в итальянской деревушке, и почему важно встретить своего мастера.
              </p>
              <br>
              <p>
                Инстаграм «Мечты»
